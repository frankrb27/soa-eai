 ...
 * 2016-12-04T22:41:41.957+05:30
 * Generated source version: 3.1.7
 * 
 */
@WebServiceClient(name = "SOATestEndpointService", 
                  wsdlLocation = "file:/C:/Camel/soap/SoapExample/src/main/resources/wsdl/test.wsdl",
...
public class SOATestEndpointService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/Camel/soap/SoapExample/src/main/resources/wsdl/test.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(SOATestEndpointService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/C:/Camel/soap/SoapExample/src/main/resources/wsdl/test.wsdl");
        }
        WSDL_LOCATION = url;
    }
